...
//lint -e26 -e30 -e31 -e42 -e48 -e50 -e63 -e64 -e78 -e86 -e101 -e119 -e129 -e142 -e144 -e156 -e409 -e438 -e505 -e515 -e516 -e522 -e525 -e528 -e529 -e530 -e533 -e534 -e539 -e546 -e551 -e560 -e565 -e574 -e578 -e601
static int forceG = 0;
...
static void put_object(int argc, char **argv, int optindex)
{
    ...
    *slash++ = 0;
    ...
    if (filename) {
        ...
        if (!contentLength) {
            ...
            while (1) {
				...
				strncat(buffer, tempBuf, RECIVE_STREAM_LENGTH - strlen(buffer) -1);
    ...
    do {
        PutObject(&bucketContext, key, contentLength, &putProperties, 0,
...
//lint +e26 +e30 +e31 +e42 +e48 +e50 +e63 +e64 +e78 +e86 +e101 +e119 +e129 +e142 +e144 +e156 +e409 +e438 +e505 +e516 +e515 +e522 +e525 +e528 +e529 +e530 +e533 +e534 +e539 +e546 +e551 +e560 +e565 +e574 +e578 +e601